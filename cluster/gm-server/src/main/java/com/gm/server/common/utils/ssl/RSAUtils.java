package com.gm.server.common.utils.ssl;

import com.common.module.cluster.property.PropertyConfig;
import com.gm.server.common.utils.file.FileListeners;
...
public class RSAUtils {
    ...
    public static void load() {
        ...
        prePrivateKey(path);
        prePublicKey(path);
        SpringUtils.getBean(FileListeners.class).addListener(new File(path), f -> f.getName().endsWith(".pem"), f -> {
    ...
    private static String getPath() {
        String rootDir = PropertyConfig.getPrefixPath() + PropertyConfig.getString("pem.path", "");
        return rootDir.endsWith("/") ? rootDir : (rootDir + "/");
    }
