package com.gm.server.common.utils.http;
...
public class HttpUtils
{
    ...
    public static byte[] getBytesBoby(HttpServletRequest req, int initBufSize) throws Exception {
        ByteArrayOutputStream baos = null;
        InputStream is = null;
        byte[] bytes = null;
        try {
            baos = new ByteArrayOutputStream(initBufSize);
