 ...
 */
@FuncName(name = "modify_gang_notice")
public class ModifyLegionNotice extends InsideServlet{
    @Override
...
//		Validate.isTrue(map.containsKey("act"), "act not exists");
        ...
        Validate.isTrue(map.containsKey("rid"), "gangsId not exists");
        Validate.isTrue(map.containsKey("notice"), "notice not exists");
        try {
            ...
            map.put("cmd", "ModifyLegionNotice");
