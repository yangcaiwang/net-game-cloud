...
public final class RouteServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<CommonProto.RouteRequest,
          CommonProto.RouteResponse> getRouteStreamMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "routeStream",
      requestType = CommonProto.RouteRequest.class,
      responseType = CommonProto.RouteResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.BIDI_STREAMING)
  public static io.grpc.MethodDescriptor<CommonProto.RouteRequest,
          CommonProto.RouteResponse> getRouteStreamMethod() {
    io.grpc.MethodDescriptor<CommonProto.RouteRequest, CommonProto.RouteResponse> getRouteStreamMethod;
      ...
      synchronized (RouteServiceGrpc.class) {
        if ((getRouteStreamMethod = RouteServiceGrpc.getRouteStreamMethod) == null) {
          RouteServiceGrpc.getRouteStreamMethod = getRouteStreamMethod =
              io.grpc.MethodDescriptor.<CommonProto.RouteRequest, CommonProto.RouteResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.BIDI_STREAMING)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "routeStream"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  CommonProto.RouteRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  CommonProto.RouteResponse.getDefaultInstance()))
  ...
  public static abstract class RouteServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public io.grpc.stub.StreamObserver<CommonProto.RouteRequest> routeStream(
        io.grpc.stub.StreamObserver<CommonProto.RouteResponse> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncBidiStreamingCall(
              new MethodHandlers<
                      CommonProto.RouteRequest,
                      CommonProto.RouteResponse>(
