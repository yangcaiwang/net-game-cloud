...
public class SerializationUtils {
	 ...
	 * @author lijishun
	 */
	public static interface MySerializable extends Externalizable {
	...
	@Deprecated
	public static <T extends Serializable> void serialize(T obj, OutputStream outputStream) {
	...
	public static <T extends Serializable> T roundtrip(T msg) {
		return org.apache.commons.lang3.SerializationUtils.roundtrip(msg);
	}
