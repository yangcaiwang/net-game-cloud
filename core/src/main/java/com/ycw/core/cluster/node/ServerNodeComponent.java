        ...
        try {
            ...
            if (nodeYml != null) {
                ...
                ServerEntity serverEntity = new ServerEntity.Builder()
                        ...
                        .jettyServerAddr(jettyYml == null ? AddressInfo.valueOf() : AddressInfo.valueOf(nodeYml.getHost(), jettyYml.getPort(), jettyYml.getHeartbeatTime(), jettyYml.getHeartbeatTimeout()))
                        .nettyServerAddr(nettyYml == null ? AddressInfo.valueOf() : AddressInfo.valueOf(nodeYml.getHost(), nettyYml.getPort(), nettyYml.getHeartbeatTime(), nettyYml.getHeartbeatTimeout()))
