...
import com.ycw.core.internal.db.sql.*;
...
public enum SQLType {
    ...
    CREATE_TABLE {
        ...
        public <T extends DBEntity> String BUILDSQL(Class<T> cls, String table) {
            ...
            return CREATETABLE.BUILDSQL(cls, table);
        }
    }, //
    ...
    INSERT {
        ...
        public <T extends DBEntity> String BUILDSQL(Class<T> cls, String table) {
            ...
            return com.ycw.core.internal.db.sql.INSERT.BUILDSQL(cls, table);
        }
    }, //
    ...
    INSERT_IGNORE {
        ...
        public <T extends DBEntity> String BUILDSQL(Class<T> cls, String table) {
            ...
            return INSERTIGNORE.BUILDSQL(cls, table);
        }
    }, //
    ...
    INSERT_EXIST_KEY_UPDATE {
        ...
        public <T extends DBEntity> String BUILDSQL(Class<T> cls, String table) {
            ...
            return INSERTONDUPLICATEKEYUPDATE.BUILDSQL(cls, table);
        }
    }, //
    ...
    DELETE_BY_KEY {
        ...
        public <T extends DBEntity> String BUILDSQL(Class<T> cls, String table) {
            ...
            return DELETEBYKEY.BUILDSQL(cls, table);
        }
    }, //
